function studyRecommendation(mathScore, physicsScore, englishScore) {
  ...
  return `Rekomendasi jurusan yang bisa dipilih: ${jurusan}`
}

console.log(studyRecommendation(80, 75, 70)); // expected Output => Rekomendasi jurusan yang bisa dipilih: Ekonomi;Sastra Inggris;Matematika;
